                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <form action="edit-staff-profile.php" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="contact" name="contact" value='<?php echo htmlspecialchars($row['contact']); ?>' class="span11 mask text" maxlength="11" pattern="\d{11}" placeholder="Enter 11-digit number" title="Please enter a 11-digit number" />
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" disabled="" value='Staff-Employee Access' class="span11" />
                                        </div>
                                    </div>
