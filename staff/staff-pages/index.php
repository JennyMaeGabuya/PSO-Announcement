                        ...
                        <div class="widget-content nopadding collapse in" id="collapseG2">
                            ...
                            <ul class="recent-posts">
                                <li>
                                    ...
                                    $qry = "SELECT * FROM announcements WHERE date >= '$one_week_ago' AND (toWho = 'Staff' OR toWho = 'All') ORDER BY date DESC";
                                    $result = mysqli_query($con, $qry);
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<p><a href='view-announcement-dashboard.php?id=" . $row['id'] . "' style='$messageStyle'>" . $message . "</a> </p>";
