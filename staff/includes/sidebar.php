...
<div id="sidebar"><a href="#" class="visible-phone"><i class="fas fa-home"></i> Dashboard</a>
  <ul style="background-color: #4E4E4E;">
    ...
    <li class="<?php if($page=='member'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-users"></i> <span>Manage Offices</span></a>
      <ul>
    ...
    <li class="<?php if($page=='equipment'){ echo 'submenu active'; } else { echo 'submenu';}?>"> <a href="#"><i class="fas fa-cogs"></i> <span>Product and Supply</span> </a>
      <ul>
    ...
    <li class="<?php if($page=='membersts'){ echo 'active'; }?>"><a href="member-status.php"><i class="fas fa-eye"></i> <span>Office's Status</span></a></li>
